            ...
            <div class="page-content" style="padding-bottom: 0px">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" id="validation-form-add">
                            ...
                            <div class="modal-footer" style="background-color: #ffffff">
                                <table style="width: 100%;text-align: center;">
                                    <tr>
                                        <td>
                                            <button id="addclose" type="button" class="btn btn-primary btn-round">关闭</button>
                                        </td>
                                        <td><button id="reset" type="reset" class="btn btn-primary btn-round">重置</button></td>
                                        <td><button id="addsubmit" type="submit" class="btn btn-primary btn-round">提交</button></td>
                                    </tr>
                                </table>
                            </div>
                        </form>
...
jQuery(function($) {
    ...
    var validator = $('#validation-form-add').validate({
        errorElement: 'div',
        ...
        /*<!--错误信息提示,和上面的规则一一对应(下面只是一部分 否则会显示默认的提示信息)-->*/
        messages: {
            email: {
                required: "email 不能为空.",
                email: "email 输入错误."
   ...
   /*增加表单提交    必须要return false，否者会刷新整个界面*/
   $("#addsubmit").click(function(){
        if(validator.form() == true){
 	  	      var onCondition = extUtil.serializeObject($("#validation-form-add"));
 	    	  utils.ajaxPost(staticParam.action_reqPath_main, "insertUserInfo", onCondition, function (o,msg) {
 	        	  msgShow = msg;
 	        	  $('#showMsg').modal({
